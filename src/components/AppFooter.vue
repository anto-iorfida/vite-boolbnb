                    ...
                    <section class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                                <h6 class="text-uppercase mb-4 font-weight-bold">Nome azienda</h6>
                                <p>
                                    Qui possiamo scrivere qualcoa jbkjd kjhkjhlu gligdk jqhòkfjh wòefjòoeijf òoijgòj
                                    gòlfjare òkgjòa ierjgò oijrgòakej
                                </p>
                            </div>
                            <!-- Grid column -->
                            ...
                            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                                ...
                                <p><a href="#" class="text-white">Tariffe di spedizione</a></p>
